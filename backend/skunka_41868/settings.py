"""
Django settings for skunka_41868 project.
...
ROOT_URLCONF = 'skunka_41868.urls'
...
WSGI_APPLICATION = 'skunka_41868.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skunka_41868 API",
    "DESCRIPTION": "API documentation for skunka_41868 App",
    "VERSION": "v1",
}
